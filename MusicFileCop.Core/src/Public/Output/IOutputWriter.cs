...
namespace MusicFileCop.Core.Output
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the checkable item that is not consitent with a rule</typeparam>
    public interface IOutputWriter<T> where T : ICheckable
    {
        ...
        /// <param name="severity">The serverity of the rule violation</param>
